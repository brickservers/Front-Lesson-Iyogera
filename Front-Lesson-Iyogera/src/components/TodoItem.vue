<template>
<div>
  <div class="level-left" v-infinite-scroll="loadMore" infinite-scroll-disabled="busy" infinite-scroll-distance="10">
  ...
  <div class="level-left">
      <div class="level-items">
        <div class="items-body-content">
            <h6 style="color: black">
              <h6 style="color: grey" >⌛️ {{todo.start_time}} - ⏳ {{todo.end_time}}</h6> 
            </h6>    
      </div>
      </div>
  </div>
